            ...
            while (true)
            {
                try
                {
                    ...
                    for (int i = 0; i < person_counter; i++)
                    {
                        ...
                        {
                            if (persons[selected_character-1].get_quantity_lifes() == 0)
                            {
                                if ((persons[selected_character-1].fraction == persons[i].fraction)&& (persons[i].hp ==0))
                                {
                                    Console.WriteLine("You lose");
                                    Console.ReadLine();
                                    return;
                                }
                                persons[selected_character - 1].x = -10;
                                persons[selected_character - 1].y = -10;
                                Console.WriteLine("You doesn't have lives for respawn\nTake the other one character");
                                Console.ReadKey();
                                person_counter--;
                            ...
                            if (persons[selected_character - 1].get_quantity_lifes() > 0)
                            {
                                Console.WriteLine("You have " + persons[selected_character - 1].get_quantity_lifes() + " lives. Want to continue?(y/n)");
                                ...
                                switch (y_n)
                                {
                                    case "y":
                                        ...
                                        Console.WriteLine("Your health: " + persons[selected_character - 1].hp);
                    ...
                    while ((persons[selected_character - 1].hp > 0) && (persons[i].hp > 0))
                    {
                        ...
                        switch (Console.ReadKey().Key)
                        {
                            case ConsoleKey.W:
                                ...
                                persons[i].taken_damage(persons[selected_character - 1].damage);
                                persons[selected_character - 1].taken_damage(persons[i].damage);
                                Console.WriteLine("HP enemy character:  " + persons[i].hp);
                                if (persons[i].hp <= 0)
                                {
                                    persons[i].x=-10;
                                    persons[i].y=-10;   
